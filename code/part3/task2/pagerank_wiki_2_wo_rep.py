...
links = spark.read.options(comment="#", delimiter="\t").csv("hdfs://10.10.1.1:9000/input/enwiki-pages-articles/*").toDF("page", "neighbor").repartition("page")
...
ranks.write.option("header",True).csv("hdfs://10.10.1.1:9000/output/pagerank_wiki_2_without_repartition_in_loop")
