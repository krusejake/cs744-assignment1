...
links = spark.read.options(comment="#", delimiter="\t").csv("hdfs://10.10.1.1:9000/input/web-BerkStan.txt").toDF("page", "neighbor").repartition("page").cache()
...
ranks.write.option("header",True).csv("hdfs://10.10.1.1:9000/output/pagerank_test_3")
spark.stop()